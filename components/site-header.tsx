        ...
        <div className="flex items-center gap-4 md:gap-2">
          ...
          <div className="md:mr-12">
            <button
              ...
              className="bg-amber-900 text-white border border-amber-400 rounded-xl py-1.5 px-3 text-[10px] font-semibold hover:bg-red-800 transition duration-200 whitespace-nowrap"
              aria-label="Login"
            >
              LOGIN
            </button>
